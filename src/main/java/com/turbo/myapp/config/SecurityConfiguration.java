package com.turbo.myapp.config;

import com.turbo.myapp.security.*;
import com.turbo.myapp.web.filter.SpaWebFilter;
        ...
        http
            ...
            .exceptionHandling(exceptionHanding ->
                exceptionHanding.defaultAuthenticationEntryPointFor(
                    ...
                    new OrRequestMatcher(new AntPathRequestMatcher("/websocket/**"), new AntPathRequestMatcher("/api/**"))
                )
            )
            .formLogin(formLogin ->
                formLogin
